...
python guided_exploration_training.py --dataset YouTube --subgraph_size 1250 --gnn_input 75 --embedding_size 25 --beta 30 --alpha 0.1 --T_train 1500 --T_test 500 --c 2 --num_eps 10 
